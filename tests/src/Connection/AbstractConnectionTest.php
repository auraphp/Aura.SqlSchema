...
use Aura\Sql_Schema_Bundle\Column;
...
abstract class AbstractConnectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->connection = $pdo_factory->newInstance(
    ...
    public function testGetProfiler()
    {
        ...
        $this->assertInstanceOf('\Aura\Sql_Schema_Bundle\Profiler', $actual);
    }
    ...
    public function testGetQueryFactory()
    {
        ...
        $this->assertInstanceOf('\Aura\Sql_Schema_Bundle\Query\Factory', $actual);
    }
    ...
    public function testNewSelect()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Select', get_class($query));
    }
    ...
    public function testNewDelete()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Delete', get_class($query));
    }
    ...
    public function testNewUpdate()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Update', get_class($query));
    }
    ...
    public function testNewInsert()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Insert', get_class($query));
    }
}
