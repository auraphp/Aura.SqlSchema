 ...
 */
class MysqlTestSchema extends AbstractSchemaTest
{
    ...
    public function testNewMysqlSelect()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Mysql\Select', get_class($query));
    }
    ...
    public function testNewMysqlDelete()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Mysql\Delete', get_class($query));
    }
    ...
    public function testNewMysqlUpdate()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Mysql\Update', get_class($query));
    }
    ...
    public function testNewMysqlInsert()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Mysql\Insert', get_class($query));
    }
}
