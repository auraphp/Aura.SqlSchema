...
/**
 * Test class for Pgsql.
 * Generated by PHPUnit on 2011-06-21 at 16:49:57.
 */
class PgsqlTestSchema extends AbstractSchemaTest
{
    ...
    public function testNewPgsqlSelect()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Pgsql\Select', get_class($query));
    }
    ...
    public function testNewPgsqlDelete()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Pgsql\Delete', get_class($query));
    }
    ...
    public function testNewPgsqlUpdate()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Pgsql\Update', get_class($query));
    }
    ...
    public function testNewPgsqlInsert()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Pgsql\Insert', get_class($query));
    }
