 ...
 */
class SqliteTestSchema extends AbstractSchemaTest
{
    ...
    public function testNewSqliteSelect()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Sqlite\Select', get_class($query));
    }
    ...
    public function testNewSqliteDelete()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Sqlite\Delete', get_class($query));
    }
    ...
    public function testNewSqliteUpdate()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Sqlite\Update', get_class($query));
    }
    ...
    public function testNewSqliteInsert()
    {
        ...
        $this->assertEquals('Aura\Sql_Schema_Bundle\Query\Sqlite\Insert', get_class($query));
    }
}
