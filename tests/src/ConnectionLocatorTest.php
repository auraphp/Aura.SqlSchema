...
class ConnectionLocatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function newManager(
        ...
        $map = [
            'mock' => 'Aura\Sql_Schema_Bundle\Connection\Mock',
        ];
    ...
    public function testGetDefault()
    {
        ...
        $this->assertInstanceOf('Aura\Sql_Schema_Bundle\Connection\Mock', $conn);
    ...
    /**
     * @expectedException Aura\Sql_Schema_Bundle\Exception\NoSuchMaster
     */
    ...
    /**
     * @expectedException Aura\Sql_Schema_Bundle\Exception\NoSuchSlave
     */
