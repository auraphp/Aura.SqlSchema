...
class GatewayTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $db_setup_class = 'Aura\Sql_Schema_Bundle\DbSetup\Sqlite';
    ...
    /**
     * @covers Aura\Sql_Schema_Bundle\Gateway::getConnections
    ...
    /**
     * @covers Aura\Sql_Schema_Bundle\Gateway::getMapper
    ...
    /**
     * @covers Aura\Sql_Schema_Bundle\Gateway::newSelect
     * @todo Implement testNewSelect().
     */
    public function testNewSelect()
    {
        $select = $this->gateway->newSelect();
        $pdo = $select->getConnection();
        $this->assertSame($this->connections->getRead(), $pdo);
        $expect = '
            SELECT
    ...
    /**
     * @covers Aura\Sql_Schema_Bundle\Gateway::fetchAll
    ...
    /**
     * @covers Aura\Sql_Schema_Bundle\Gateway::fetchOne
    ...
    /**
     * @covers Aura\Sql_Schema_Bundle\Gateway::fetchPairs
    ...
    /**
     * @covers Aura\Sql_Schema_Bundle\Gateway::fetchValue
