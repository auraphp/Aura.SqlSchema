<?php
namespace Aura\Sql_Schema_Bundle\Query\Mysql;

class SelectTest extends \Aura\Sql_Schema_Bundle\Query\AbstractQueryTest
{
    protected $query_type = 'Mysql\Select';
    ...
    public function testDistinct()
    {
        ...
        $expect = $expect = sprintf($this->expected_sql_with_flag, 'DISTINCT');
